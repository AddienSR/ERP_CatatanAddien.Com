...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card card-chart card-success">
        ...
        <div class="col-lg-4">
            <div class="card card-chart">
                <div class="card-header">
                    ...
                    <h3 class="card-title"><i class="tim-icons icon-money-coins text-light"></i>{{ format_money($semesterincomes) }}</h3>
                </div>
                <div class="card-body">
                    <div class="chart-area">
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('sales.create') }}" class="btn btn-sm btn-light">Penjualan Baru</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-6 col-md-12">
            <div class="card card-tasks">
                ...
                <div class="row">
                        ...
                        <div class="col-4 text-right">
                            <button type="button" class="btn btn-sm btn-light" data-toggle="modal" data-target="#transactionModal">
                                Transaksi Baru
                            </button>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('transactions.create', ['type' => 'payment']) }}" class="btn btn-sm btn-success">Payment</a>
                        <a href="{{ route('transactions.create', ['type' => 'income']) }}" class="btn btn-sm btn-success">Income</a>
                        <a href="{{ route('transactions.create', ['type' => 'expense']) }}" class="btn btn-sm btn-success">Expense</a>
                        <a href="{{ route('sales.create') }}" class="btn btn-sm btn-success">Penjualan</a>
                        <a href="{{ route('transfer.create') }}" class="btn btn-sm btn-success">Pemindahan</a>
                    </div>
                </div>
            </div>
        </div>
