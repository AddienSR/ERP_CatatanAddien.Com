@extends('layouts.app', ['page' => 'Tanda Terima', 'pageSlug' => 'receipts', 'section' => 'inventory'])
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-4 text-right">
                        <a href="{{ route('receipts.create') }}" class="btn btn-sm btn-success">Tanda Terima Baru</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
