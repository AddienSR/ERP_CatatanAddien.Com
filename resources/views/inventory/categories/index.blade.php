@extends('layouts.app', ['page' => 'Daftar Kategori', 'pageSlug' => 'categories', 'section' => 'inventory'])
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('categories.create') }}" class="btn btn-sm btn-success">Kategori Baru</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
