@extends('layouts.app', ['page' => 'Beban', 'pageSlug' => 'expenses', 'section' => 'transactions'])
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('transactions.create', ['type' => 'expense']) }}" class="btn btn-sm btn-success">Daftar Beban</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
