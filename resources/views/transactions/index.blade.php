@extends('layouts.app', ['page' => 'Transaksi', 'pageSlug' => 'transactions', 'section' => 'transactions'])
            ...
            <div class="card ">
                ...
                <div class="row">
                        ...
                        <div class="col-4 text-right">
                            <button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#transactionModal">
                                Transaksi Baru
                            </button>
                        </div>
                    </div>
