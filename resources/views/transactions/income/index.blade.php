@extends('layouts.app', ['page' => 'Pendapatan', 'pageSlug' => 'incomes', 'section' => 'transactions'])
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('transactions.create', ['type' => 'income']) }}" class="btn btn-sm btn-success">Daftar Pendapatan</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
