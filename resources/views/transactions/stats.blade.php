@extends('layouts.app', ['pageSlug' => 'tstats', 'page' => 'Statistika', 'section' => 'transactions'])
            ...
            <div class="card card-tasks">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('clients.index') }}" class="btn btn-sm btn-success">Melihat Klien</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
            ...
            <div class="card card-tasks">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('methods.index') }}" class="btn btn-sm btn-success">Melihat Metode</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-4 text-right">
                        <a href="{{ route('sales.index') }}" class="btn btn-sm btn-success">Melihat Penjualan</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
