@extends('layouts.app', ['page' => 'Transaksi Baru', 'pageSlug' => 'clients', 'section' => 'transactions'])
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('clients.show', $client) }}" class="btn btn-sm btn-success">Back to Client</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
