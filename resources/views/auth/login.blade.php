@extends('layouts.app', ['class' => 'login-page', 'page' => 'Catatan Addien Com', 'contentClass' => 'login-page', 'section' => 'auth'])
        ...
        <form class="form" method="post" action="{{ route('login') }}">
            ...
            <div class="card card-login card-dark">
                ...
                <div class="card-footer">
                    <button type="submit" href="" class="btn btn-success btn-lg btn-block mb-3">Masuk</button>
                    <div class="pull-left">
                        <h6>
