@extends('layouts.app', ['class' => 'register-page', 'page' => 'Catatan Addien Com', 'contentClass' => 'register-page', 'section' => 'auth'])
            ...
            <div class="card card-register card-dark">
                ...
                <form class="form" method="post" action="{{ route('register') }}">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-success btn-round btn-lg">Daftar</button>
                    </div>
                </form>
            </div>
        </div>
