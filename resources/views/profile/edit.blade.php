@extends('layouts.app', ['page' => __('Profil Pengguna'), 'pageSlug' => 'profile', 'section' => 'users'])
        ...
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <form method="post" action="{{ route('profile.password') }}" autocomplete="off">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-fill btn-success">Perubahan Kata Sandi</button>
                    </div>
                </form>
            </div>
        </div>
