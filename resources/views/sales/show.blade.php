@extends('layouts.app', ['page' => 'Manajemen Penjualan', 'pageSlug' => 'sales', 'section' => 'transactions'])
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        @if (!$sale->finalized_at)
                            <div class="col-4 text-right">
                                <a href="{{ route('sales.product.add', ['sale' => $sale->id]) }}" class="btn btn-sm btn-success">Add</a>
                            </div>
                        @endif
                    </div>
                </div>
