@extends('layouts.app', ['page' => 'Tambahkan Produk', 'pageSlug' => 'sales', 'section' => 'transactions'])
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('sales.show', [$sale->id]) }}" class="btn btn-sm btn-success">Kembali ke Daftar</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
