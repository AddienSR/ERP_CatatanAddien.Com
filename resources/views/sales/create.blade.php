@extends('layouts.app', ['page' => 'Pendaftaran Penjualan', 'pageSlug' => 'sales-create', 'section' => 'transactions'])
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('sales.index') }}" class="btn btn-sm btn-success">Kembali ke Daftar</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
